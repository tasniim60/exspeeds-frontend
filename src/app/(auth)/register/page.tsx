          ...
          <div className="w-full max-w-[430px] bg-white/95 backdrop-blur-xl rounded-[32px] p-6 sm:p-8 border border-orange-100/90 shadow-[0_20px_50px_rgba(37,21,22,0.1)] text-center space-y-3.5 relative z-20">
            ...
            <div>
              <button
                ...
                className="w-full h-11 rounded-xl border border-gray-200 hover:border-gray-300 bg-white hover:bg-gray-50/80 text-gray-700 font-bold text-xs sm:text-sm flex items-center justify-center gap-2.5 shadow-2xs hover:shadow-xs transition-all cursor-pointer"
              >
