...
function TrackContent() {
  ...
  const [lastTrackedResult, setLastTrackedResult] = useState<{
    carrierKey: string;
    carrierName: string;
    cleanAwb: string;
  ...
  const executeTracking = (carrierKey: string, rawAwb: string) => {
    ...
    const result = trackShipment(carrierKey, clean);

    setLastTrackedResult({
      carrierKey: result.carrierKey,
      carrierName: result.carrierName,
      cleanAwb: result.cleanAwb,
  ...
  const handleCopyAwb = () => {
    if (lastTrackedResult?.cleanAwb) {
      navigator.clipboard.writeText(lastTrackedResult.cleanAwb);
      setCopied(true);
