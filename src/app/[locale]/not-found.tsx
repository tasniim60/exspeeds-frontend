        ...
        <div className="relative bg-white rounded-3xl border border-gray-200/80 p-6 sm:p-10 shadow-xl shadow-gray-200/50 overflow-hidden text-center">
          ...
          <div className="relative z-10 max-w-xl mx-auto space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <Link
                href="/"
                className="min-h-[44px] px-6 py-2.5 rounded-xl bg-brand-dark hover:bg-brand-dark-hover active:scale-[0.98] text-white font-bold text-xs sm:text-sm inline-flex items-center gap-2 shadow-md transition-all cursor-pointer"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="w-9 h-9 rounded-xl bg-orange-50 text-brand-orange flex items-center justify-center group-hover:scale-105 transition-transform">
                  <PackageSearch className="w-4.5 h-4.5" />
                </div>
                <ArrowIcon className="w-4 h-4 text-gray-300 group-hover:text-brand-orange group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 transition-all" />
              </div>
              <div>
                <span className="text-xs font-bold text-gray-900 group-hover:text-brand-orange transition-colors block">
