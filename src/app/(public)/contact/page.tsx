          ...
          <div className={`lg:col-span-5 space-y-6 ${isRTL ? "text-right" : "text-left"}`}>
            <div className="space-y-2">
              ...
              <p className="text-gray-600 text-sm leading-relaxed font-medium">
                {isRTL
                  ? "مركز العمليات والتوزيع الرئيسي بمطار القاهرة الدولي مجهز بأحدث منصات المناولة السريعة والتخزين الجمركي المؤقت."
                  : "Strategically located at Cairo International Airport Cargo Village, operating round-the-clock for seamless air & multimodal transfers."}
              </p>
            </div>
            ...
            <div className="pt-2">
              <a
                href="https://maps.google.com/?q=Cairo+International+Airport,Egypt"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#FAF8F5] hover:bg-white text-gray-900 border border-gray-200 px-6 py-3 rounded-full font-bold text-xs sm:text-sm shadow-2xs hover:border-[#C45B2A] transition-all"
              >
            ...
            <div className="bg-white rounded-[32px] overflow-hidden border border-orange-100 shadow-xl flex flex-col">
              <div className="bg-gray-50/90 border-b border-gray-100 py-3.5 px-6 flex items-center justify-between text-xs">
                <div className="flex items-center gap-2 font-bold text-gray-900">
                  ...
                  <span>{isRTL ? "موقع قرية البضائع - مطار القاهرة الدولي" : "Cargo Village Hub - Cairo International Airport"}</span>
                </div>
              ...
              <div className="relative min-h-[380px] w-full bg-gray-100">
                <iframe
                  title="XSPEED Office Location"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13818.156828555627!2d31.1444!3d29.9936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145845c4794b6555%3A0xa645c7b39922e964!2sAl%20Haram%2C%20Giza%20Governorate%2C%20Egypt!5e0!3m2!1sen!2seg!4v1700000000000!5m2!1sen!2seg"
