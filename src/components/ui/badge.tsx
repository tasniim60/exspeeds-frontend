...
const badgeVariants: Record<string, string> = {
  default: "bg-brand-dark text-white border border-transparent",
  ...
  brand: "bg-brand-orange/10 text-brand-orange border border-brand-orange/20 font-semibold",
  info: "bg-orange-50 text-brand-orange border border-orange-200",
