      ...
      <section className="relative py-20 lg:py-28 px-4 sm:px-6 lg:px-8 border-b border-[#E2E8F0] overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-5 relative z-10">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            <div className="bg-white/90 backdrop-blur-md px-5 py-2 rounded-full border border-slate-200 shadow-2xs flex items-center gap-2.5 text-xs font-bold text-gray-800">
            ...
            <div
              ...
              className={`bg-white/95 backdrop-blur-md rounded-[32px] p-7 sm:p-8 border ${
                dept.isPrimary
                  ...
                  : "border-slate-200 shadow-[0_10px_30px_rgba(15,23,42,0.04)]"
            ...
            >
              <div className="space-y-4">
                ...
                <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                  <div className="bg-[#F8FAFC] p-3 rounded-xl border border-slate-200 flex items-center gap-2.5">
                ...
                <a
                  ...
                  className={`w-full py-3.5 px-6 rounded-full font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-sm ${
                    dept.isPrimary
                      ...
                      : "bg-[#F8FAFC] hover:bg-white text-gray-900 border border-slate-200 hover:border-[#C45B2A]"
                  }`}
                >
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className={`lg:col-span-5 space-y-6 ${isRTL ? "text-right" : "text-left"}`}>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3.5 bg-[#F8FAFC] p-4 rounded-2xl border border-slate-200">
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#F8FAFC] hover:bg-white text-gray-900 border border-slate-200 px-6 py-3 rounded-full font-bold text-xs sm:text-sm shadow-2xs hover:border-[#C45B2A] transition-all cursor-pointer"
              >
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-[32px] overflow-hidden border border-slate-200 shadow-xl flex flex-col">
      ...
      <section className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 space-y-10">
        ...
        <div className="space-y-4">
          {faqs.map((faq, fIdx) => (
            <div
              key={fIdx}
              className="bg-white/95 backdrop-blur-md rounded-2xl border border-slate-200 overflow-hidden shadow-2xs"
            >
              <button
                type="button"
